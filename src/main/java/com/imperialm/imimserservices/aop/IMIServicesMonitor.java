 ...
 *
 */
package com.imperialm.imimserservices.aop;
...
public class IMIServicesMonitor {
	...
	@AfterThrowing(pointcut = "execution(* com.imperialm.imimserservices..*.*(..))", throwing = "error")
	...
	@Around("execution(* com.imperialm.imimserservices..*.*(..))")
