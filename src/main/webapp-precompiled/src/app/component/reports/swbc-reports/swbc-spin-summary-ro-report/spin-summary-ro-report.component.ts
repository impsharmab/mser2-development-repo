...
@Component({
    selector: 'spin-summary-report',
    templateUrl: './spin-summary-ro-report.html',
    // styleUrls: ['./UCONNavigationActivation-report.component.css']
})
export class SWBCSpinSummaryROReportComponent implements OnInit {
    ...
    public viewReport() {
        if (this.selectedPeriod == "") {
            ...
            var programName = "SWBCSpinsROSummary_Excel";
