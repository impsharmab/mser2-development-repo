...
@Component({
    moduleId: module.id,
    selector: 'inactiveopcodedatatable',
    template: ``
})

export class InactiveOpcodeTableComponent implements OnChanges, OnDestroy {
    private otable: any;
    private randomId: any = new Date().valueOf();
    private tableObj: any;
    @Input("tableData") tableData: any;
    @Input("columnsHeader") columns: any;
    @Output("ClickOnCell") click: EventEmitter<any> = new EventEmitter<any>();
